...
class Layout
{
	private $CI; //Valeur de retour de la fonction get_instance
	private $output = ''; //Contenu HTML qui sera inséré dans le layout
...
/*
|===============================================================================
| Méthodes pour ajouter changer le theme
|	. set_theme
|===============================================================================
*/
	public function set_theme($theme)
	{
		if(is_string($theme) AND !empty($theme) AND file_exists('./application/layout/' . $theme . '.php'))
		{
			$this->theme = $theme;
			return true;
		}
